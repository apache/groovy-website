...
We can solve this problem using matrices. If we multiply the matrix image:img/FibMatrix.png[fibonacci matrix] by itself n times we get image:img/FibMatrixN.png[fib n matrix].
