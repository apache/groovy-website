...
:updated: 2026-09-18T20:00:00+00:00
...
native binary per script. The example repo has three Micronaut scripts:
the two we just saw, plus a `Tools` variant which adds weather and weekend tools.
...
*18/Sep/2026*: Updated for the latest library versions and added Micronaut native image examples.
****
