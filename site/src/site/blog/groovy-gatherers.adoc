...
:updated: 2026-09-15T14:00:00+00:00
:keywords: gatherers, jdk24, jdk25, chop, collate, inject, ginq, streams, jep461, fold, scan
...
The examples in this blog were tested with Groovy 6.0.0 and JDKs 17, 21 and 25.
The Gatherer examples need JDK 24 or later, where the gatherers API is final.
The Groovy collection equivalents shown alongside them also work with earlier
Groovy and JDK versions, including JDK 8 with Groovy 4.
...
*15/Sep/2026*: Updated for Groovy 6 and JDK 25.
****
