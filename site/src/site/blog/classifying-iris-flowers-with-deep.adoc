...
----
[lime]*paulk@pop-os*pass:v[:][blue]*/extra/projects/iris_encog*$ time groovy -cp "build/lib/*" IrisEncog.groovy
1/5 : Fold #1
...
[source,subs="quotes,macros"]
----
[lime]*paulk@pop-os*pass:v[:][blue]*/extra/projects/iris_encog*$ time groovy -cp "build/lib/*" IrisDl4j.groovy
...
[source,subs="quotes,macros"]
----
[lime]*paulk@pop-os*pass:v[:][blue]*/extra/projects/iris_encog*$ time groovy -cp "build/lib/*" Iris.groovy
...
[source,subs="quotes,macros"]
----
[lime]*paulk@pop-os*pass:v[:][blue]*/extra/projects/iris_encog*$ groovyc -cp "build/lib/*" --compile-static Iris.groovy
----
...
[source,subs="quotes,macros"]
----
[lime]*paulk@pop-os*pass:v[:][blue]*/extra/projects/iris_encog*$ native-image  --report-unsupported-elements-at-runtime \
