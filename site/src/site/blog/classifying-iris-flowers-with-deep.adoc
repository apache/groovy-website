...
Paul King
:revdate: 2022-06-25
:keywords: groovy, machine learning, artificial intelligence, neural networks, tribuo, deep netts, encog, eclipse deepLearning4j, data science, deep learning
...
image:https://blogs.apache.org/groovy/mediaresource/80b1adc8-7234-4046-a279-e272b0a0edd4[iris flowers,200,float="right"]
