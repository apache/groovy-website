...
downloads {
    distribution('Groovy 5.0') {
        ...
        version('5.0.0-alpha-3') {
            stable false
//            windowsInstaller 'https://groovy.jfrog.io/artifactory/dist-release-local/groovy-windows-installer/groovy-5.0.0-alpha-3/'
        }
    ...
    distribution('Groovy 4.0') {
        ...
        version('4.0.16') {
            stable true
//            windowsInstaller 'https://groovy.jfrog.io/artifactory/dist-release-local/groovy-windows-installer/groovy-4.0.16/'
        }
        version('4.0.15') {
            stable true
            archive true
