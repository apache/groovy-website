...
downloads {
    distribution('Groovy 6.0') {
        ...
        version('6.0.0-RC-3') {
            stable false
//            windowsInstaller 'https://groovy.jfrog.io/artifactory/dist-release-local/groovy-windows-installer/groovy-6.0.0-RC-3/'
        }
    ...
    distribution('Groovy 5.1') {
        ...
        version('5.1.3') {
            stable true
//            windowsInstaller 'https://groovy.jfrog.io/artifactory/dist-release-local/groovy-windows-installer/groovy-5.1.3/'
        }
        version('5.1.1') {
            stable true
            archive true
