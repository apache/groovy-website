...
//            windowsInstaller 'https://groovy.jfrog.io/artifactory/dist-release-local/groovy-windows-installer/groovy-4.0.11/'
    ...
    distribution('Groovy 3.0') {
        ...
        version('3.0.17') {
            stable true
//            windowsInstaller 'https://groovy.jfrog.io/artifactory/dist-release-local/groovy-windows-installer/groovy-3.0.17/'
        }
        version('3.0.16') {
            stable true
            archive true
    ...
    distribution('Groovy 2.5') {
        ...
        version('2.5.22') {
            stable true
//            windowsInstaller 'https://groovy.jfrog.io/artifactory/dist-release-local/groovy-windows-installer/groovy-2.5.22/'
        }
        version('2.5.21') {
            stable true
            archive true
