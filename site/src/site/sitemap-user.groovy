...
documentation {
    groovyDocumentationVersions([
            ...
            '2.5.0-rc-1', '2.5.0-rc-2', '2.5.0-rc-3', '2.5.0', '2.5.1', '2.5.2', '2.5.3', '2.5.4', '2.5.5', '2.5.6', '2.5.7', '2.5.8', '2.5.9', '2.5.10',
...
downloads {
    ...
    distribution('Groovy 3.0') {
        ...
        version('3.0.3') {
            stable true
            //windowsInstaller 'https://dl.bintray.com/groovy/Distributions/groovy-3.0.3.msi'
        }
        version('3.0.2') {
            stable true
            archive true
            windowsInstaller 'https://dl.bintray.com/groovy/Distributions/groovy-3.0.2.msi'
        }
    }
    distribution('Groovy 2.5') {
        ...
        version('2.5.10') {
            stable true
//            windowsInstaller 'https://dl.bintray.com/groovy/Distributions/groovy-2.5.10-installer.exe'
        }
        version('2.5.9') {
            stable true
            archive true
